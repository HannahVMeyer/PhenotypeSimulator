...
if (!dir.exists(datadirectory)) dir.create(datadirectory, recursive=TRUE)
...
saveRDS(simulation, paste(savedir, "/simulation.rds", sep=""))
```
...
savedir <- paste(system.file("extdata", package="PhenotypeSimulator"), 
                            "/resultsSimulationAndLinearModel", sep="")
simulation <- readRDS(paste(savedir, "/simulation.rds", sep=""))
```
