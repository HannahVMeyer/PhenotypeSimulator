...
knitr::include_graphics("wallthickness.png")
```
...
cor_pheno <- cor(pheno)
knitr::include_graphics("cor_pheno.png")
```
...
```{r distribution simulated data, fig.cap="\\label{fig:distribution_simulated}**Distribution of simulated covariates.**", fig.align='center'}
...
```{r, echo=FALSE, out.width='\\textwidth', fig.align='center', fig.cap="\\label{fig:corsimulated}\\textbf{Correlation of simulated spatial proximity.}"}
knitr::include_graphics("cor_simulated.png")
```
