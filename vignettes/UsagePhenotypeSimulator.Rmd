...
Background noise effects are simulated as two random noise effects (shared and independent). The shared background effect is simulated as $vec(common) ~ N(mean,sd)$. The independent background effect  is simulated as the matrix product of two normal distributions A [N x 1] and B [P x 1]: $specific=AB^T$
