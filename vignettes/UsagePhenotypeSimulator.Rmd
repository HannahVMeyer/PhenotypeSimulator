...
kinship <- getKinship(X=genotypes$X_sd, verbose = FALSE)
...
kinshipFile <- system.file("extdata/kinship/", "kinship.csv", 
                           package = "PhenotypeSimulator")
kinshipFromFile <- getKinship(kinshipfile = kinshipFile, 
                              verbose = FALSE)
