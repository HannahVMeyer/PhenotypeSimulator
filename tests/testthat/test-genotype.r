...
test_that('standardiseGenotypes returns output matrix/dataframe of same dimension as input matrix/dataframe', {
...
test_that('getKinshio fails if neither kinshipfile nor genotype matrix are provided',{
